...
pygame.display.set_caption("Menu Intermediário")
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(100).render('ARRASOU!', True, "#FF69B4")
        MENU_RECT = MENU_TEXT.get_rect(center=(640, 100))

        PLAY_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(640, 250),
                            text_input="FASE SEGUINTE", font=get_font(40), base_color="#FFE4E1", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(650, 650),
                            text_input="OPÇÕES", font=get_font(25), base_color="#FFE4E1", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("assets/Quit Rect.png"), pos=(640, 550), 
                            text_input="SAIR", font=get_font(75), base_color="#FFE4E1", hovering_color="White")
